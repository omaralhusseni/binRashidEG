  ...
  return (
    <main ref={container} className="w-full home relative kkfont normal">
      ...
      <section className="section1 w-screen h-screen bg-white z-0 overflow-hidden">
        <div className="text kkfont normal text-left absolute z-10 w-full bg-white p-4 top-0 pt-16 md:pt-24">
          <p className="text-xl md:text-3xl lg:text-5xl">Business Setup In Emirates </p>
          <p className="text-[#1D7CB9] mt-2 text-xl md:text-3xl lg:text-5xl">And In Saudi Arabia</p>
        </div>
      ...
      <div className="video-sections-container relative h-screen w-screen">
        ...
        <div id="home" className="home-wrapper absolute w-screen h-screen z-40">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-white p-4 md:p-8 w-full max-w-4xl mx-auto">
              <div className="bg-black bg-opacity-30 rounded-lg p-4 md:p-8">
                <h1 className="text-xl md:text-2xl lg:text-3xl mb-4 md:mb-6 market-head">
                  Deep Market Expertise in Saudi Arabia & UAE
                </h1>
                <p className="text-sm md:text-base lg:text-lg market-body leading-relaxed">
        ...
        <div id="services" className="services-wrapper absolute w-screen h-screen z-40">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-white p-4 md:p-8 w-full max-w-4xl mx-auto">
              <div className="bg-black bg-opacity-30 rounded-lg p-4 md:p-8">
                <h1 className="text-xl md:text-2xl lg:text-3xl mb-4 md:mb-6 services-head">
                  Comprehensive Business Setup Services
                </h1>
                <p className="text-sm md:text-base lg:text-lg services-body leading-relaxed">
      ...
      <div id="values" className="values-wrapper relative h-screen w-screen">
        <div
          ref={thirdSectionRef}
          className="section5 absolute w-screen h-screen z-50 bg-[#1D7CB9] overflow-y-auto"
        >
          <div className="flex items-center justify-center min-h-screen py-8">
            <div className="text-center text-white p-4 md:p-8 w-full max-w-4xl mx-auto">
              <h1 className="text-3xl md:text-4xl lg:text-5xl mb-6 md:mb-8 font-bold values-head">
                Our Core Values
              </h1>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mt-8">
                <div className="p-4 md:p-6 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
                  <h3 className="text-lg md:text-xl lg:text-2xl mb-3 font-semibold">Excellence</h3>
                ...
                <div className="p-4 md:p-6 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
                  <h3 className="text-lg md:text-xl lg:text-2xl mb-3 font-semibold">Trust</h3>
                  <p className="text-sm md:text-base lg:text-lg">
                ...
                <div className="p-4 md:p-6 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
                  <h3 className="text-lg md:text-xl lg:text-2xl mb-3 font-semibold">Innovation</h3>
                  <p className="text-sm md:text-base lg:text-lg">
