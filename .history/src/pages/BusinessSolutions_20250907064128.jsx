  ...
  return (
    <main ref={containerRef} className="w-full relative kkfont normal">
      ...
      <section ref={heroRef} className="hero-section h-screen bg-gradient-to-br from-[#1D7CB9] to-[#0F4A6B] flex items-center justify-center relative overflow-hidden">
        ...
        {/* Professional hexagon pattern - hide on mobile */}
        ...
        <div className="relative z-10 text-center text-white px-4 md:px-8 max-w-6xl">
          <h1 className="hero-title text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-light tracking-tight mb-4 md:mb-8">
            We solve your{" "}
          ...
          <p className="hero-subtitle text-lg sm:text-xl md:text-2xl font-light opacity-90 max-w-4xl mx-auto leading-relaxed px-2">
            Comprehensive business solutions designed to
            <br className="hidden md:block" />transform challenges into opportunities
          </p>
        </div>
      </section>
      ...
      <section ref={pinnedSectionRef} className="methodology-section min-h-screen bg-gradient-to-br from-blue-900 to-indigo-900 flex items-center justify-center relative overflow-hidden">
        <div className="text-center text-white px-4 md:px-8 max-w-6xl relative z-10 py-12 md:py-0">
          <div className="methodology-content flex flex-col items-center justify-center space-y-6 md:space-y-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light mb-8 md:mb-12 tracking-tight text-center">Our Methodology</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-5xl">
              {methodologyPhases.map((phase, index) => (
                <div key={index} className="methodology-phase bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 md:p-8 border border-white border-opacity-20 relative overflow-hidden">
      ...
      {/* Reasons Section */}
      <section ref={reasonsRef} className="reasons-section min-h-screen bg-white flex items-center justify-center relative py-12 md:py-0">
        <div className="max-w-7xl mx-auto px-4 md:px-8 w-full">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-6 tracking-tight">
              Why You Need<br />Business Solutions
            </h2>
            <div className="w-24 md:w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto"></div>
          </div>
          
          <div className="reasons-content flex flex-col items-center justify-center space-y-4 md:space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-6xl">
              {whyChooseReasons.map((reason, index) => (
                <div key={index} className="reason-card bg-white rounded-xl shadow-lg p-4 md:p-8 text-center">
      ...
      <div className="relative h-screen">
        <section ref={slidingSectionRef} className="absolute w-full h-full bg-gradient-to-r from-green-600 to-blue-700 flex items-center justify-center text-white">
          <div className="text-center px-4 md:px-8 max-w-5xl">
            ...
            <button className="bg-white text-blue-700 px-8 md:px-12 py-3 md:py-4 rounded-lg text-base md:text-lg font-semibold hover:bg-gray-100 transition-colors duration-300 transform hover:scale-105 shadow-lg">
              Get Started Now
            </button>
          </div>
        </section>
      ...
      <section ref={solutionsRef} className="solutions-section min-h-screen bg-gradient-to-r from-gray-50 to-gray-100 flex items-center justify-center relative py-12 md:py-0">
        <div className="max-w-6xl mx-auto px-4 md:px-8 text-center w-full solutions-content">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light mb-6 md:mb-8 text-gray-900 tracking-tight">
            360° Business Solutions
          </h2>
          <div className="solutions-line w-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-8 md:mb-12"></div>
          <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto font-light px-2">
      ...
      <section className="min-h-screen bg-white flex items-center justify-center relative py-12 md:py-0">
        <div className="max-w-7xl mx-auto px-4 md:px-8 w-full">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-6 tracking-tight">
              Our Service Portfolio
            </h2>
            <div className="w-20 md:w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto"></div>
          </div>
          
          <div className="services-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 relative">
            {services.map((service, index) => (
              <div key={index} className="service-card group">
                <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4 md:p-8 border border-gray-100 hover:border-[#1D7CB9] transform hover:-translate-y-2">
                  <div className={`w-12 h-12 md:w-16 md:h-16 ${service.color} rounded-full mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300`}></div>
                  <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-3 md:mb-4 group-hover:text-[#1D7CB9] transition-colors duration-300">
                    {service.title}
                  </h3>
                  <div className="w-8 md:w-12 h-1 bg-[#1D7CB9] group-hover:w-full transition-all duration-300"></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 md:py-20 bg-[#1D7CB9] text-white">
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-8">
            Ready to Transform Your Business?
          </h2>
          <p className="text-base md:text-xl mb-8 md:mb-12 opacity-90 px-2">
            Let's discuss how our comprehensive solutions can address your specific challenges and drive sustainable growth.
          </p>
          <button className="bg-white text-[#1D7CB9] px-8 md:px-12 py-3 md:py-4 rounded-lg text-base md:text-lg font-semibold hover:bg-gray-100 transition-colors duration-300 transform hover:scale-105">
